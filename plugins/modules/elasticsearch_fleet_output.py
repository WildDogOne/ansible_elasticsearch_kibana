...
def main():
    module_args = dict(
        ...
        output_type=dict(type="str", required=True),
        output_hosts=dict(type="list", required=True),
        output_id=dict(type="str", required=True),
        output_name=dict(type="str", required=True),
        is_default=dict(type=bool, required=True),
        is_default_monitoring=dict(type=bool, required=True),
        ca_trusted_fingerprint=dict(type="str", required=True),
        config_yaml=dict(type="str", required=True),
